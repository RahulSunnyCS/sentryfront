...
- [ ] Phase 5 — Tests + docs + E2E (in progress)
  ...
  - qa-gap test-writer: 3 files present (qa-gap-performance / qa-gap-i18n-catalog / qa-gap-p4-05-null-guard) — awaiting its completion report (coverage map + confirm no real-bug finding + full-suite green) before commit.
